...
public class MainActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    String kota;
    ArrayList<ListHome> mList = new ArrayList<>();
...
//        setSupportActionBar(toolbar);
        ...
        mAdapter = new KotaHomeAdapter(mList);
        recyclerView.setAdapter(mAdapter);
        fillData();


        HashMap<String, Integer> file_maps = new HashMap<String, Integer>();
        file_maps.put("Surabaya", R.drawable.sby);
        file_maps.put("Malang", R.drawable.mlg);
...
//        });
    ...
    private void fillData() {
        ...
        String[] arKota = resources.getStringArray(R.array.places);
        ...
        a.recycle();
        for (int i = 0; i < arKota.length; i++) {
            mList.add(new ListHome(arKota[i], arDeskripsi[i], arFoto[i]));
        }
